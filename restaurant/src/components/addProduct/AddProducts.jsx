...
export default function AddProducts() {
  ...
  useEffect(() => {
    dispatch(getCategory(token, user?.userId));
  }, []);
  ...
  console.log(categoryFile?.name.replace(/\s+/g, "_"));
  ...
  const handleAddProduct = (e) => {
    ...
    const product = {
      ...
      categoryId: productCatRef.current.value || null,
      restaurantId: user?.userId, // Pass user ID
  ...
  const handleUploadCategory = (e) => {
    ...
    const category = {
      ...
      categoryImage: categoryFile?.name.replace(/\s+/g, "_"),
      restaurantId: user?.userId,
    };

    //console.log(category);

    dispatch(uploadCategory(categoryFile, category,token));
      ...
      <div className="add-product-wrapper">
        ...
        <form onSubmit={handleAddProduct} className="new-product-form">
          ...
          <div className="veg-wrap">
            <label htmlFor="select-category">Vegeterian? </label>
            <select
              type="text"
              id="select-category"
              required
          ...
          <div className="category-wrap">
            ...
            <select
              ...
              ref={productCatRef}
            >
              <option value="">No Category</option> {/* Empty option */}
