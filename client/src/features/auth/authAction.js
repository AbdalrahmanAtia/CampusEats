...
const signUp = (username, email, password, phoneNumber, studentId, university) => async (dispatch) => {

  try {

    dispatch(signUpRequest());
    // Call your backend API to register the user
    const response = await axios.post(`${import.meta.env.VITE_API_BASE_URI}/users/register`,
      {
      username,
      email,
      password,
